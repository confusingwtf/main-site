...
const RANDOMVID = '<video id="funni-vid" muted autoplay meow controls onloadstart="this.volume=0.3;lastVidEnded=false" src="{BASEDIRPLACEHOLDER}/{RANDOMVIDPLACEHOLDER}" poster="/assets/img/spiny.gif" width="125" style="float: right"></video>';
var clicked = false;
